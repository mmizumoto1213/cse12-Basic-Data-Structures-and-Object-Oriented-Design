 ...
 * 
 * This file contains the ticket class. This class creates a ticket similar to
 * what the tutor hours autograder tickets are like. This ticket uses a
 * hashmap to determine priority between queue types.
 */
...
public class Ticket implements Comparable<Ticket>{
    ...
    /**
     * This method compares two tickets and returns a number based on which
     * which ticket has higher priority.
     * @param other - The other ticket being compared to.
     * @return - a negative, positive, or 0 integer depending on priority.
     */
    @Override
    public int compareTo(Ticket other){
        // When ticket types are the same this checks the time it was created
        // to determine priority 
        if (orderMap.get(getTicketType()).equals(
        ...
        // Checks hashmap for ticket type priority
        if (orderMap.get(getTicketType()) < 
            orderMap.get(other.getTicketType())) {
            return -1;
        }
        return 1;
